          ...
          <h3 class="card-title">
            <table>
              <tr>
                <td>
                  <nuxt-link
                    :to="{ name: 'erp_whu-admin-employee' }"
                    class="nav-link"
                  >
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <nuxt-link
                  :to="{
                    name: 'erp_whu-admin-employee_activity_group-create-id',
          ...
          >
            ...
            <template v-slot:cell(actions)="row">
              <b-button
                :to="{
                  name: 'erp_whu-admin-employee_activity_group-edit-id',
            ...
            <template v-slot:cell(detail)="row">
              <b-button
                :to="{
                  name: 'erp_whu-admin-employee_activity_group',
