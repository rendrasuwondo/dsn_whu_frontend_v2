    ...
    <section class="content">
      <div class="card card-outline card-info">
        <div class="card-header">
          <h3 class="card-title">
            <i class="nav-icon fas fa-seedling"></i> BATCH BIBITAN
          </h3>
...
export default {
  ...
  methods: {
    ...
    exportData() {
      ...
      this.$axios({
        url: `/api/admin/batch_bibitan/export?q=${this.search}&q_department_id=${this.query_department_id}`,
        method: 'GET',
        responseType: 'blob',
        ...
        link.href = url
        var fileName = 'BATCH BIBITAN.xlsx'
