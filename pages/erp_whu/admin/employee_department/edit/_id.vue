    ...
    <section class="content">
      <div class="card card-outline card-info">
        <div class="card-header">
          <h3 class="card-title">
            <i class="nav-icon fas fa-address-card"></i> EDIT DEPARTMENT
          </h3>
...
export default {
  ...
  head() {
    return {
      title: 'Edit Department Tambahan ',
    }
  },
  ...
  mounted() {
    ...
    //Data Afdeling
    this.$axios
      .get('/api/admin/lov_department_tambahan')
    ...
    this.$axios
      .get(`/api/admin/employee_department/${this.$route.params.id}`)
      .then((response) => {
        //data yang diambil
  ...
  methods: {
    ...
    async updateData(e) {
      ...
      await this.$axios
        .put(`api/admin/employee_department/${this.$route.params.id}`, {
          //data yang dikirim
