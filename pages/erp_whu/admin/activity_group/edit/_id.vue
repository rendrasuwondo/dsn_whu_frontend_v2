    ...
    <section class="content">
      <div class="card card-outline card-info">
        <div class="card-header">
          <h3 class="card-title">
            <i class="nav-icon fas fa-layer-group"></i> EDIT GRUP
          </h3>
...
export default {
  ...
  mounted() {
    ...
    this.$axios
      .get(`/api/admin/activity_group/${this.$route.params.id}`)
      .then((response) => {
        //data yang diambil
  ...
  methods: {
    back() {
      this.$router.push({
        name: 'erp_whu-admin-activity_group',
    ...
    async update(e) {
      ...
      await this.$axios
        .put(`/api/admin/activity_group/${this.$route.params.id}`, {
          //data yang dikirim
